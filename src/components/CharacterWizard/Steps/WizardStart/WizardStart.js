  ...
  return (
    <div className="wizard-start-container">
      ...
      <span className="wizard-nav-next">
        <Button variant="contained" raised component={Link} to="/character-wizard/1"> &rarr;</Button>
      </span>
      </div>
      ...
      <p>
        When you continue on from here, you will choose a race (such as human or
        halfling) and a class (such as fighter or wizard). You also roll to
